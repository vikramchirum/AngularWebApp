...
import { delay, forEach, pull, random, result } from 'lodash';
...
export class MyServicePlansComponent implements OnInit, OnDestroy {
  ...
  public doughnutChartDataSet: Observable<any[]> = null;
  ...
  buildChart(
    ...
    console.log(totalDaysOfContract, ' = ', totalDaysUsed, ' + ', totalTimeRemaining);
    ...
    forEach(this.chartObservers, observer => {
      observer.next([
        blueBar,
        greenBar,
        yellowBar,
